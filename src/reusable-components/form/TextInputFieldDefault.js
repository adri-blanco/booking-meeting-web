...
import SCTextField from './TextInputField';

const TextInputFieldDefault = ({
  disabled,
  placeholder,
  label,
  name,
...
TextInputFieldDefault.propTypes = {
...
TextInputFieldDefault.defaultProps = {
  disabled: false,
  placeholder: '',
  label: '',
  required: false,
...
export default TextInputFieldDefault;
